<%@ Page Title="" Language="C#" MasterPageFile="~/Hired_dotnet.Master" AutoEventWireup="true" CodeBehind="companylogin.aspx.cs" Inherits="Hired_dotnet.companylogin" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <a href="companysignup.aspx"><input class="btn btn-info btn-block btn-lg" id="Button2" type="button" value="Sign Up" /></a>
                        </div>
                     </div>
                  </div>
               </div>
