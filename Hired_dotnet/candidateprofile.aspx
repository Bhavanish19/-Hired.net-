<%@ Page Title="" Language="C#" MasterPageFile="~/Hired_dotnet.Master" AutoEventWireup="true" CodeBehind="candidateprofile.aspx.cs" Inherits="Hired_dotnet.candidateprofile" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Candidate ID" ReadOnly="True"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
