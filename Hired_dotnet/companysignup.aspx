<%@ Page Title="" Language="C#" MasterPageFile="~/Hired_dotnet.Master" AutoEventWireup="true" CodeBehind="companysignup.aspx.cs" Inherits="Hired_dotnet.companysignup" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox8" runat="server" placeholder="Company ID"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-6">
